...
// Source: github.com/smw-104/ladon (interfaces: Manager)
...
import (
	...
	ladon "github.com/smw-104/ladon"
)
...
func (_m *MockManager) FindPoliciesForSubject(_param0 string, _param1 int64, _param2 int64) (ladon.Policies, error) {
...
func (_mr *_MockManagerRecorder) FindPoliciesForSubject(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "FindPoliciesForSubject", arg0, -1, -1)
}
